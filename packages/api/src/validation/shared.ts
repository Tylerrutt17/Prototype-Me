...
// ── Enums ───────────────────────────────────
export const noteKind = z.enum(["regular", "mode", "framework", "situation", "goal"]);
...
export const directiveHistoryAction = z.enum(["create", "update", "graduate", "snooze", "balloon_pump", "shrink", "split", "checklist_complete"]);
