...
final class IntroPageViewController: UIViewController {
    ...
    private let slides: [SlideData] = [
        ...
        SlideData(icon: "brain.head.profile", title: "Ask Feature, You Confirm", subtitle: "Ask Feature suggests structure. You review, edit, and own every decision.", accentColor: DesignTokens.Colors.accentSecondary),
